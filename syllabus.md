...
Students are also expected to possess a basic mathematical background, including elementary calculus, linear algebra, algebra, and basic notions of algorithmic complexity. Familiarity with standard mathematical notation commonly used in computational science is assumed.
...
Dedicated hands-on sessions will be held after each frontal lecture. During the hands-on sessions, students will have the opportunity to work on computational problems involving algorithm design, numerical computing, linear algebra, and scientific data processing, closely related to the material covered in the frontal lectures. The solutions to these problems might be discussed, allowing students to receive feedback and gain a deeper understanding of the material.
...
1. Programming: Principles and Practice Using C++, 3rd Edition, Bjarne Stroustrup, Addison-Wesley, April 2024.
2. Guide to Scientific Computing in C++, 2nd Edition, Joe Pitt-Francis and Jonathan Whiteley, Springer, 2018.
3. Learning Scientific Programming with Python, 2nd Edition, Christian Hill, Cambridge University Press, October 2020.
...
Any recent Linux distribution, such as Ubuntu 24.04 or newer, or Debian 12 or newer, or a macOS system that meets these requirements should be suitable for the course.
